...
if page == "Connexion":
    ...
    st.write("Tableau 1.2.4: Répartition régionale des postes de responsabilités occupés par les femmes dans les mairies (maire, 1er adjoint au maire, 2ème adjoint au maire) aux exercices municipaux ")
    uploaded_file = st.file_uploader("Importer les données", type=["xlsx"],
    ...
    st.write("Tableau 1.2.5: Répartition des maires par département, par sexe et par partie politique (on pourrait aussi voir l'évolution)")
    uploaded_file = st.file_uploader("Importer les données ", type=["xlsx"],
